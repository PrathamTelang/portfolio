...
export const Background = () => {
  return (
    <div className="flex w-screen pt-12  items-center justify-center bg-lightbg bg-[repeating-linear-gradient(45deg,var(--color-lightborder)_0_1px,transparent_1px_8px)]
